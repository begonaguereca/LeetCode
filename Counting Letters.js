...
var numberOfLines = function(widths, S) {
  let dictionary = creatDictionary(widths),
  pageCount = 1,
  wordCount = 0;

  S.split('').forEach(val => {
    wordCount += dictionary[val];
    console.log(val, dictionary[val], wordCount)
